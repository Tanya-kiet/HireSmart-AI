...
function DeleteModal({ candidate, isOpen, onClose, onConfirm }) {
      ...
      <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl border border-slate-200 p-6 z-10 space-y-5">
        ...
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1 leading-relaxed">
            Are you sure you want to delete <strong className="text-slate-900">{candidate.name}</strong> ({candidate.filename})? This action cannot be undone.
          </p>
        </div>
